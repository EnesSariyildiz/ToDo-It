...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container col-md-5 col-md-offset-3 mt-5">
        ...
        <div>
            ...
            <div class="mt-3">
                <button type="button" class="btn btn-dark btn-lg" style="width: 300px;">
                <a href="https://github.com/EnesSariyildiz/to-do-it" >GitHub</a>
                    </button>
            </div>

            <div>
                <img src="image/ExamplelesSourceCode.png" class="rounded-lg mt-3" />
            </div>
        </div>
    </div>
</asp:Content>
