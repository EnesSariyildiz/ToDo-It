...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container col-md-5 col-md-offset-3 mt-5">
        ...
        <div class="mt-5">
            <h6 class="mb-3">• Instagram</h6>
            <button type="button" class="btn btn-dark btn-lg" style="width: 300px;">
        ...
        <div>
            <h6 class="mt-5">- You can find the source code of this project here.</h6>
            <div class="mt-3">
                <a href="https://github.com/EnesSariyildiz/to-do-it" class="text-white link-class btn btn-dark btn-lg" target="_blank" style="width: 300px;">GitHub</a>
            </div>

            <div>
                <img src="image/ExamplelesSourceCode.png" class="rounded-lg mt-3 mb-5" />
            </div>
        </div>
    </div>
</asp:Content>
